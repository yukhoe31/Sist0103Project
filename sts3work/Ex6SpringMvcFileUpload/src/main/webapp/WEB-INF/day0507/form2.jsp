		...
		<tr>
			...
			<td>
				<select name="image" class="form-control">
					<option value="rabbit_1.png">사진1</option>
					<option value="redbird.png">사진2</option>
					<option value="yellowbird.png">사진3</option>
					<option value="tree6.gif">사진4</option>
					<option value="bell2.gif">사진5</option>
				</select>
			</td>
		</tr>
