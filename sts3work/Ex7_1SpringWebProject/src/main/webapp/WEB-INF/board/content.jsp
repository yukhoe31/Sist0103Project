...
<body>
	<div style="margin: 100px 100px; width: 600px;">
		<table class="table table-bordered">
			...
			<tr>
				<td><b>${dto.writer }</b> <span style="float: right;">조회:
						${dto.readcount }</span> <c:if test="${dto.photo != 'no'}">
						<c:forTokens items="${dto.photo}" delims="," var="clip">
							<div>
								<a href="download?clip=${clip}"> 
								<i class="bi bi-file-earmark-arrow-down"></i><span>${clip}</span>
								</a>
							</div>
						</c:forTokens>
					</c:if>
