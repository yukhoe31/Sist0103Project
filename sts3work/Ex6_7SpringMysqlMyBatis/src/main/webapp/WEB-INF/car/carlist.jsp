...
<div style="margin: 50px 100px; width: 800px;">
    <button type="button" class="btn btn-info" onclick="location.href='writeform'" style="margin-left: 600px;">자동차정보입력</button>
    <br><br>
            ...
            <c:forEach var="dto" items="${list }" varStatus="i">
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-outline-info btn-sm" onclick="confirmDelete(${dto.num})">삭제</button>
                    </td>
                </tr>
            </c:forEach>
        </table>
