...
<div style="margin: 30px 50px;">
	<form action="d2_addAction.jsp" method="post" enctype="intro/form-data">
		<table class="table table-bordered border-success"style="width:600px;">
		...
		<tr>
			<th>취미</th>
			<td>
			   <label><input type="checkbox" name="hobby" value="게임" checked="checked" >게임</label> 
		...
		<tr>
			...
			<td>
				<textarea style="width:500px; height:100px;" placeholder="자유롭게 서술하세요."
				 name="memo" class="form-control"></textarea>
			</td>
		</tr>
